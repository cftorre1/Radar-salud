...
`hola@alicanto.cl` y `radar@alicanto.cl` son identidades deseadas, no buzones activos. Dirección debe aprobar el proveedor de correo y configurar/verificar SPF, DKIM y DMARC antes de prometer recepción o envío. El enlace de contacto institucional público esperará a que el buzón exista. No comprar dominio, correo ni servicios desde Work.
